...
//    }
    ...
    public Car findCarById(Long id) {
        ...
        return springCarRepository.findById(id).orElseThrow(() -> new CarNotFoundException("No car with id: " + id));
    }
    ...
    public Car updateCar(Long id, Car carToUpdate) {
        ...
        Color color = carToUpdate.getColour();
        ...
        if (!Objects.equals(mileage, carFromRepository.getMileage())) {
